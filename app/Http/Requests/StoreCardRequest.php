...
class StoreCardRequest extends FormRequest
{
	...
	public function rules()
	{
		return [
			...
			// movement can only be 0-99 digit OR single F or N
			'movement' => array( 'required', 'regex:/^[0-9]{1,2}$|^[NF]{1}$/' ),
	...
	public function messages()
	{
		...
		return [
			...
			'movement.required'  => $required_ru,
			'movement.regex'  => '0+ у существ, N у артефактов, F у летающих',
